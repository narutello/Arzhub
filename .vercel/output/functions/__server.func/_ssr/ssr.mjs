...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjHtZwVK.mjs");
...
var manifest = {
	"3266bff51ec4af028e1d7d28d4b8b927550c23c7d34481a77c369b883260ebe8": {
		functionName: "getRates_createServerFn_handler",
		importer: () => import("./market-B-G6ISdX.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CSzsPqoA.mjs").then((n) => n.t),
